                    ...
                    <div class="user-profile layout-spacing">
                        <div class="widget-content widget-content-area">
                            <div class="d-flex justify-content-between">
                                <h3 class="">&nbsp;&nbsp;&nbsp;Info</h3>
                                <a href="userProfileSetting.jsp" class="mt-2 edit-profile"> <svg
                            ...
                            <div class="text-center user-info">
                                <img src="profileImage/<%=image%>" alt="avatar" width="90px" height="90px">
                                    <p class=""><% out.println(firstName);
                    ...
                    <div class="bio layout-spacing ">
                        <div class="widget-content widget-content-area">
                            ...
                            <div class="bio-skill-box">
                                <div class="row">
                                    <%int c = 0;%>
                                    <% String str = "SELECT T.*, P.IMAGE, P.NAME, P.ID FROM TRANSACTIONS T, PRODUCT P WHERE T.PRODUCTID = P.ID AND RATING > 0 AND P.Status = '1' AND T.USERNAME = ?"; %>
                                    <% ustmt = conn.prepareStatement(str);%>
                                    <% ustmt.setString(1, sessionName); %>
