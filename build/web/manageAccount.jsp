                        ...
                        <div class="widget-content widget-content-area">
                            ...
                            <form method="get" action="manageAccount.jsp">
                                <div class="input-group mb-4">
                                    <input type="text" id="searchResult" name="searchResult" value="<%=request.getParameter("searchResult")%>" class="form-control" placeholder="Search name, username or email here">
                                    <input type="hidden" name="bannedUser" value="">
                            ...
                            <h6 style="color: red"> <%=request.getParameter("bannedUser")%> has been banned. </h6><br>
                            <% }%>
                            <div class="table-responsive">

                                <jsp:include page="include/userTable.jsp" /> 
