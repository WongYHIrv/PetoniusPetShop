<%-- 
    Document   : account ROLE management
    Author     : TanKX
--%>
                ...
                <div class="col-xl-12 col-lg-6 col-md-7 col-sm-12 ">
                    <div class="bio layout-spacing ">
                        <div class="widget-content widget-content-area">
                            ...
                            <form method="get" action="manageRole.jsp">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="hidden" name="changedUser" value="">
                                    <input type="hidden" name="changedRole" value="">
                            ...
                            <% if (!request.getParameter("changedUser").equals("") && !request.getParameter("changedRole").equals("")) {%>
                            <h6 style="color: red"> <%=request.getParameter("changedUser")%> has been update to 
                                <%
                                    if (request.getParameter("changedRole").equals("A"))  {
                                        out.println("Admin.");
                                    } else if (request.getParameter("changedRole").equals("M")) {
                                        out.println("Manager.");
                                    } else if (request.getParameter("changedRole").equals("C")) {
                            ...
                            <div class="table-responsive">
                                ...
                                <jsp:include page="include/roleTable.jsp" /> 
