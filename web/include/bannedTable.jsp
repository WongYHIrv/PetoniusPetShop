...
<table class="table table-bordered table-striped mb-4">
    <thead>
        <tr>
            ...
            <th width="25%">
                ...
                <a href="manageBannedAccount.jsp?searchResult=<%=request.getParameter("searchResult")%>&unbannedUser=&orderBy=firstname&sorting=DESC">
                    <img src="image/down.png" width="10px" height="10px">
                </a>
                <%} else {%>
                <a href="manageBannedAccount.jsp?searchResult=<%=request.getParameter("searchResult")%>&unbannedUser=&orderBy=firstname&sorting=ASC">
            ...
            <th width="25%">
                ...
                <a href="manageBannedAccount.jsp?searchResult=<%=request.getParameter("searchResult")%>&unbannedUser=&orderBy=username&sorting=DESC">
                    <img src="image/down.png" width="10px" height="10px">
                </a>
                <%} else {%>
                <a href="manageBannedAccount.jsp?searchResult=<%=request.getParameter("searchResult")%>&unbannedUser=&orderBy=username&sorting=ASC">
                    <img src="image/top.png" width="10px" height="10px">
                </a>
                <%}%>
            </th>
            <th width="25%">
                ...
                <a href="manageBannedAccount.jsp?searchResult=<%=request.getParameter("searchResult")%>&unbannedUser=&orderBy=email&sorting=DESC">
                    <img src="image/down.png" width="10px" height="10px">
                </a>
                <%} else {%>
                <a href="manageBannedAccount.jsp?searchResult=<%=request.getParameter("searchResult")%>&unbannedUser=&orderBy=email&sorting=ASC">
                    <img src="image/top.png" width="10px" height="10px">
                </a>
                <%}%>
            </th>
            <th width="10%">
                ...
                <a href="manageBannedAccount.jsp?searchResult=<%=request.getParameter("searchResult")%>&unbannedUser=&orderBy=position&sorting=DESC">
                    <img src="image/down.png" width="10px" height="10px">
                </a>
                <%} else {%>
                <a href="manageBannedAccount.jsp?searchResult=<%=request.getParameter("searchResult")%>&unbannedUser=&orderBy=position&sorting=ASC">
                    <img src="image/top.png" width="10px" height="10px">
                </a>
                <%}%>
            </th>
    ...
    <tbody>
        ...
        <% String retrieveStr = "SELECT * FROM " + tableName + " WHERE STATUS = FALSE AND (UPPER(USERNAME) LIKE ? OR UPPER(FIRSTNAME) LIKE ? OR UPPER(LASTNAME) LIKE ? OR UPPER(EMAIL) LIKE ?) ORDER BY " +request.getParameter("orderBy")+ " " + request.getParameter("sorting"); %>
